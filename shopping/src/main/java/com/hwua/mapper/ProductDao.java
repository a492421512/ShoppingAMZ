...
public interface ProductDao {
    ...
    public abstract List<Product> queryProductLimit() throws SQLException;//分页查询
    ...
    public abstract Integer delProStock(@Param("id") Long id, @Param("pnum") Long pnum) throws SQLException;//删除对应的库存
}
