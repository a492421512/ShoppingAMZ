...
<script type="text/javascript" src="scripts/product_view.js"></script>
	...
	<script>
		...
		function productPage() {
            ...
            $.post("${pageContext.request.contextPath}/Product/productById",{"id":$id},function (data) {

                var $position = $("#position1");
                var $posA;
                if (data.sonName==data.parentName){
                    $posA = $("<a href='${pageContext.request.contextPath}/index.jsp'>亚马逊</a> > <a href='${pageContext.request.contextPath}/product-list.jsp?id="+data.parId+"'>" + data.parentName + "</a>");
                } else {
                    $posA = $("<a href='${pageContext.request.contextPath}/index.jsp'>亚马逊</a> > <a href='${pageContext.request.contextPath}/product-list.jsp?id="+data.parId+"'>" + data.parentName + "</a> > <a href='${pageContext.request.contextPath}/product-list.jsp?id="+data.sonId+"'>" + data.sonName + "</a>");
                }
				...
				$("#buyPro").click(function () {
				    ...
				    if ($("#count").val()<=0){
						...
						window.location="${pageContext.request.contextPath}/doBuy/buyOne?pid="+$em.id+"&pnum="+$("#count").val()+"";
					}
                });
                ...
                $("#shopCar").click(function () {
                    ...
                    if ($("#count").val()<=0){
                    	...
                    	alert("加购成功!");
                    	window.location="${pageContext.request.contextPath}/shopCar/showCar?id="+$em.id+"&num="+$("#count").val()+"";
					}
                })
            },"json")
