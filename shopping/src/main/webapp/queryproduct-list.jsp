...
<script type="text/javascript" src="scripts/function.js"></script>
	...
	<script>
		$(function () {
			...
			var $qname = getUrlParam('qname');
			$.post("${pageContext.request.contextPath}/proCategory/queryProList",{"qname":$qname},function (data) {
...
<body>
	...
	<div id="position" class="wrap">
		您现在的位置：<%--<a href='ProductServlet'>亚马逊</a> &gt; <a href='product-list.jsp'></a> &gt; &ndash;%&gt;--%>
	</div>
