	...
	<script>
		...
		function event(obj) {
            ...
            $("#minusCar",obj).click(function () {
                ...
                $.post("${pageContext.request.contextPath}/shopCar/update",{"pnum":$count.val(),"id":$id,"type":"-"},function (data) {
            ...
            $("#countCar",obj).blur(function () {
                ...
                var $id = $(this).parents("tr").find("#hidden").val();
                var $price = $(this).parents("tr").find("#span_1");
                $.post("${pageContext.request.contextPath}/shopCar/update",{"pnum":$count.val(),"id":$id,"type":"updateNum"},function (data) {
                    if (data.updatesuccess) {
                        //修改页面商品价格
                        $price.html(data.updateCart.subtotal);
                    }else {
            ...
            $("#delCar",obj).click(function () {
                ...
                var $id = $(this).parents("tr").find("#hidden").val();
                window.location = "${pageContext.request.contextPath}/shopCar/delPro?id="+$id+"";
            })
...
<div class="wrap">
	<div id="shopping">
		<form action="${pageContext.request.contextPath}/doBuy/buy" method="post">
			<table id="table">
				<tr>
					<th>商品名称</th>
					<th>商品价格</th>
